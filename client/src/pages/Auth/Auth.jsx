        ...
        <div className="a-right">
            <form className="infoForm authForm" onSubmit={handleSubmit}>
                ...
                <h3>{isSignUp? "Sign up": "Log in"}</h3>
                    ...
                    {isSignUp &&  (                 <div>                 <input type="text" placeholder='First Name' className='infoInput' name='firstname'
                ...
                <div>
                    ...
                    onChange={handleChange}
                    value = {data.password}/>
                    {isSignUp && <input type="password" className="infoInput" name='confirmpass' placeholder='Confirm Password'
                    onChange={handleChange}
                ...
                <div>
                    <span style={{fontSize: '13px', cursor: "pointer"}}onClick = {()=>{setIsSignUp((prev)=>!prev); resetForm()}} >{isSignUp? "Already have an account? LogIn!": "Don't have an account? SignUp!"}</span>
                </div>
